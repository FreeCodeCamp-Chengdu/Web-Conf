define({
    ...
    "guests": [
        {
            ...
            "avatar": "guest0.jpeg",
            "content": "叶小钗嘉宾开场演讲",
            "description": "原医联研发副总监，现为企鹅医生技术总监，研发负责人。先后任职于携程百度等公司，擅长前端开发，混合开发，对大型前端项目开发有一些认识，平时喜欢霹雳布袋戏。"
        },
        {
            "name": "陈洋彬",
            "avatar": "guest7.jpeg",
            "content": "一个 Node 模块的自我修养",
            "description": "麦麦养老软件研发负责人，持续创业者。在研发团队搭建、管理与技术体系渐进增强方面有一定心得。多年 Web 前端、服务端研发及架构设计经验，关注技术的原理与融会贯通，主张编码与工程的专业、规范、极简。"
        },
        {
            "name": "水歌",
            "avatar": "guest4.jpeg",
            "content": "轻量级 Web MVVM 引擎的实现",
            "description": "东方天呈 Web 前端工程师，JavaScript 全栈开发者、开源软件作者、FreeCodeCamp 中文社区技术布道师、四川大学飞扬俱乐部·研发部 创始团队成员、jQuery贡献者。"
        },
        {
            "name": "廖伟",
            "avatar": "guest2.jpeg",
            "content": "HTML 5 跨平台解决方案实践",
            "description": "乐车邦前端开发负责人。曾就职于携程移动端框架技术部，负责构建代码的打包平台，维护共用组件，目前在乐车邦主要负责整个前端（浏览器，微信，小程序，app），致力于解决一套代码多端运行的方案，主要擅长 SPA 应用的开发，具有丰富的SPA开发经验。"
        },
        {
            "name": "胡敏",
            "avatar": "guest5.jpeg",
            "content": "Vue 开发那些事",
            "description": "新蛋高级软件工程师。目前主要负责 Web 模块化开发平台建设与开发工作，擅长功能设计与实现。对前后端开发有较多实践经验。"
        },
        {
            "name": "董涛",
            "avatar": "guest6.jpeg",
            "content": "大数据可视化之美",
            "description": "5年前端经验，热爱钻研各种技术，喜欢写代码，工作之余著有 MTUI、H5DS 两个开源项目。现 BBD 前端部部门经理，对 Web 交互，以及数据可视化有丰富经验。"
        },
        {
            "name": "卢林",
            "avatar": "guest3.jpeg",
            "content": "React 组件化通用模式",
            "description": "国双科技高级软件工程师，曾供职于奇虎 360 奇舞团、麦客 CRM。目前专注于端技术体系，喜欢思考软件开发的通用模式。"
        },
        {
            "name": "余泽江",
            "avatar": "guest1.jpeg",
    ...
    "flows": [
        ...
        },
        {
            ...
            "guest": 1,
            "content": "叶小钗嘉宾开场演讲",
            "description": "【主题描述】内容暂时保密~"
        },
        {
            "time": "10：20",
            "guest": 2,
            "content": "一个 Node 模块的自我修养",
            "description": "【主题描述】作为一个“全干”工程师，与你朝夕相处的 Node 模块，说简单可以简单到一个 index.js 和一个 package.json，说复杂也可以复杂到必须引入工程化的理念来管理。本分享来一起探讨下一个开源 Node 模块，所应该考虑的目录结构、代码检查、单元测试、基准测试、持续集成、自动构建、版本发布、变更记录等等这些需求，如何高效、规范的去实现"
        },
        {
            "time": "11：10",
            "guest": 3,
            "content": "轻量级 Web MVVM 引擎的实现",
            "description": "【主题描述】只依赖 HTML 5、JS (ES 5) 的纯异步加载、声明式的 MVVM 引擎，它的简洁用法与内部实现"
        },
        {
            "time": "12：00",
            "guest": false,
            "content": "午餐时间（与嘉宾近距离交流）",
            "description": "【备注】为了大家可以自行选择美食，所以午餐可以到会场外的银泰城解决哦~"
        },
        {
            "time": "13：00",
            "guest": 4,
            "content": "HTML 5 跨平台解决方案实践",
            "description": "【主题描述】乐车邦创业阶段，前端开发人数相对较少，但是平台众多，常用的如：浏览器、乐车邦 App、微信公众号网页版本、微信小程序。还有不计其数的定制化流量平台，如：手淘、百度地图、汽车之家、百度糯米、58到家、新美大等等，虽然渠道众多，但是业务流程相对统一，如何利用一套 HTML 5 代码解决多终端运行问题成了前端重中之重。"
        },
        {
            "time": "13：50",
            "guest": 5,
            "content": "Vue 开发那些事",
            "description": "【主题描述】通过对 Vue 项目开发中遇到的部分通用问题进行分解，探索特定问题或场景的解决方案。从目录结构划分、业务封装等方面来提升项目的可维护性。"
        },
        {
            "time": "14：40",
            "guest": 6,
