define({
    ...
    flows: [
        ...
        },
        {
            ...
            content: "一个 Node 模块的自我修养",
            description:
                "【主题描述】作为一个“全干”工程师，与你朝夕相处的 Node 模块，说简单可以简单到一个 index.js 和一个 package.json，说复杂也可以复杂到必须引入工程化的理念来管理。本分享来一起探讨下一个开源 Node 模块，所应该考虑的目录结构、代码检查、单元测试、基准测试、持续集成、自动构建、版本发布、变更记录等等这些需求，如何高效、规范的去实现"
        },
        {
            time: "11：10",
            guest: 3,
            content: "轻量级 Web MVVM 引擎的实现",
            description:
                "【主题描述】只依赖 HTML 5、JS (ES 5) 的纯异步加载、声明式的 MVVM 引擎，它的简洁用法与内部实现"
        },
        {
            time: "12：00",
            guest: false,
            ...
            description:
                "【备注】为了大家可以自行选择美食，所以午餐可以到会场外的银泰城解决哦~"
        },
        {
            time: "13：00",
            guest: 4,
            content: "HTML 5 跨平台解决方案实践",
            description:
                "【主题描述】乐车邦创业阶段，前端开发人数相对较少，但是平台众多，常用的如：浏览器、乐车邦 App、微信公众号网页版本、微信小程序。还有不计其数的定制化流量平台，如：手淘、百度地图、汽车之家、百度糯米、58到家、新美大等等，虽然渠道众多，但是业务流程相对统一，如何利用一套 HTML 5 代码解决多终端运行问题成了前端重中之重。"
        },
        {
            time: "13：50",
            guest: 5,
            content: "Vue 开发那些事",
            description:
                "【主题描述】通过对 Vue 项目开发中遇到的部分通用问题进行分解，探索特定问题或场景的解决方案。从目录结构划分、业务封装等方面来提升项目的可维护性。"
        },
        {
            time: "14：40",
            guest: 6,
            content: "大数据可视化之美",
            description:
                "【主题描述】如何让繁杂的数据以最简最直观的形式呈现在用户的眼前？数据可视化真的那么高不可攀吗？今天就让我们来聊聊大数据可视化的常用技巧和常用算法吧！"
        },
        {
            time: "15：20",
            guest: false,
        ...
        },
        {
            ...
            content: "React 组件化通用模式",
            description:
                "【主题描述】通过 React 项目的开发过程以及多个框架的使用，提取组件化开发的通用思路，对组件化、组件容器化以及微服务前端开发方式的一点思考。"
        },
        {
            time: "16：40",
            guest: 8,
