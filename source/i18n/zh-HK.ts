...
export default {
    ...
    homepage_description: '中國西南地區 Web、JavaScript 全棧開發者年度盛會',
    homepage_register_latest: '報名最新大會',
    homepage_review_previous: '回顧上次大會',
    chengdu_community: '成都社區',
    organizer_introduction: '主辦方簡介',
    national_it_events: '全國 IT 活動',
    coscon_23_main_venue: "COSCon'23（中國開源年會）主會場",
    nonprofit_organization: '非牟利組織',
    since2014:
        '自 2014 年成立以來，以「幫助人們免費學習編程」為使命，創建了大量免費的編程教程，包括互動式課程、視頻課程、文章等。線下開發者社區遍布 160 多個國家、2000 多個城市。我們正在幫助全球數百萬人學習編程，希望讓世界上每個人都有機會獲得免費的優質的編程教育資源，成為開發者或者運用編程去解決問題。',
    community_description:
        ' 成立於 2016 年，是中國大陸最早一批 FCC 城市線下社區，目前會員逾千人，也是最大的 FCC 城市社區。在核心團隊 20 餘人兩年的努力下，FCC 成都已覆蓋編程教育、技術招聘、行業大會等程序員全職業生涯的公益服務。',
    sina_weibo: '新浪微博',
    wechat_public_account: '微信公眾號',
    proudly_developed_with: '自豪地使用',
    development: '開發',
    back_to_top: '返回頂部',
    chengdu_web_full_stack_conference_2019: '2019 成都 Web 全棧大會',
